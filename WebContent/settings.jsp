...
<form action = "settings" method = "post" enctype = "multepart/form-date"><br>
	...
	<textarea name = "description" rows="5" cols="35" id = "description"><c:out value = "${editUser.description }" /></textarea><br>
